...
namespace BookingSystem.Helpers
{
    public class SurveyCheckboxCollections
    {
        private Dictionary<string, CheckboxData> secondarySchoolCheckboxes = new Dictionary<string, CheckboxData>()
            {
                {"Q2Male", new CheckboxData() {startX = 182, startY = 197, endX = 238, endY = 227, AveragePixels = 1570.6025f} },
                {"Q2Female", new CheckboxData() {startX = 249, startY = 196, endX = 313, endY = 239, AveragePixels = 2653.8171f } },
                {"Q2Other", new CheckboxData() {startX = 325, startY = 197, endX = 383, endY =  227, AveragePixels = 1649.4243f} },
                {"Q2DontWantToSay", new CheckboxData() {startX = 385, startY = 194, endX = 528, endY =  229, AveragePixels = 4781.2983f} },
